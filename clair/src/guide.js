...
function Guide() {
    ...
    this.buttonWorkFlowEditPath = function(){
                    ...
                    <div id="modal-close-shadow">
                        ...
                        <div id="modal-help-text">
                          <ul>
                            ...
                            see in the left pane those steps, and you will see an arrow showing the <br>
                            WorkFlow path.</p></li>
                            ...
                            Drag it and drop it over another component to set the fork s target.</p></li>
                            <li><p>The (+) symbol over the arrow is to insert another step between two.</p></li>
    ...
    this.buttonWorkFlowEditSteps = function(){
