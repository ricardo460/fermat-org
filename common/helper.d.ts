...
declare namespace Helper {
    ...
    export function showMaterial(material : THREE.Material, duration? : number, easing? : (number) => number, delay? : number) : void;
    ...
    export function isValidVector(vector: THREE.Vector3 | { x: number, y: number, z: number }): boolean;
    export function showBackButton() : void;
    export function hideBackButton() : void;
    export function getCenterView(view : string) : THREE.Vector3;
    export function fillTarget(x: number, y: number, z: number, view: string): { show: any, hide: any };
