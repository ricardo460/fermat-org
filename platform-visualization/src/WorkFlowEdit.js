function WorkFlowEdit() {
    ...
    function createWorkFlow(){
        ...
        window.routesAPI.postRoutesProcess('insert', params, null,
            function(res){ 
        ...
        function postParamsSteps(flow, callback){
            ...
            function postSteps(steps){
                ...
                if(steps.length > 0){ 
                    ...
                    window.routesAPI.postRoutesProcess('insert step', param, dataPost,
                        function(res){
    ...
    function modifyWorkFlow(){ 
        ...
        window.routesAPI.postRoutesProcess('update', params, dataPost,
            function(res){ 
        ...
        function postParamsStep(flow, callback){
            ...
            function postSteps(task, array, callback){
                ...
                if(array.length > 0){
                    ...
                    window.routesAPI.postRoutesProcess(config[task].route, param, dataPost,
                        function(res){
    ...
    function deleteWorkFlow(id){
        ...
        window.routesAPI.postRoutesProcess('delete', false, dataPost,
            function(res){
